// Node.js script to generate SVG files
const fs = require('fs');
const path = require('path');

// 基本的な立方体SVG
const generateCubeBasicSVG = () => {
...
// 3×3行列の基本パターン
const generateMatrix3x3BasicSVG = () => {
...
// 数列表示用SVG
const generateNumberSequenceBoxesSVG = () => {
...
// パターンシーケンスSVG
const generatePatternSequenceShapesSVG = () => {
...
// デフォルトIQテストSVG
const generateDefaultIQTestSVG = () => {
...
const main = () => {
  ...
  const svgFiles = [
    ...
    { name: 'cube-rotation-120.svg', content: generateCubeBasicSVG() },
    { name: 'matrix-3x3-basic.svg', content: generateMatrix3x3BasicSVG() },
    { name: 'matrix-3x3-rotation.svg', content: generateMatrix3x3BasicSVG() },
